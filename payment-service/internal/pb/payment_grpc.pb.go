...
type PaymentServiceClient interface {
	...
	GetAllPayments(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*PaymentList, error)
	GetPaymentByID(ctx context.Context, in *GetByIDRequest, opts ...grpc.CallOption) (*Payment, error)
	UpdatePayment(ctx context.Context, in *UpdatePaymentRequest, opts ...grpc.CallOption) (*Payment, error)
	DeletePayment(ctx context.Context, in *GetByIDRequest, opts ...grpc.CallOption) (*Empty, error)
}
...
func (c *paymentServiceClient) GetAllPayments(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*PaymentList, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PaymentList)
...
func (c *paymentServiceClient) GetPaymentByID(ctx context.Context, in *GetByIDRequest, opts ...grpc.CallOption) (*Payment, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Payment)
...
func (c *paymentServiceClient) DeletePayment(ctx context.Context, in *GetByIDRequest, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
...
type PaymentServiceServer interface {
	...
	GetAllPayments(context.Context, *Empty) (*PaymentList, error)
	GetPaymentByID(context.Context, *GetByIDRequest) (*Payment, error)
	UpdatePayment(context.Context, *UpdatePaymentRequest) (*Payment, error)
	DeletePayment(context.Context, *GetByIDRequest) (*Empty, error)
...
func (UnimplementedPaymentServiceServer) GetAllPayments(context.Context, *Empty) (*PaymentList, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAllPayments not implemented")
}
func (UnimplementedPaymentServiceServer) GetPaymentByID(context.Context, *GetByIDRequest) (*Payment, error) {
...
func (UnimplementedPaymentServiceServer) DeletePayment(context.Context, *GetByIDRequest) (*Empty, error) {
...
func _PaymentService_GetAllPayments_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServiceServer).GetAllPayments(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _PaymentService_GetPaymentByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServiceServer).GetPaymentByID(ctx, req.(*GetByIDRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _PaymentService_DeletePayment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServiceServer).DeletePayment(ctx, req.(*GetByIDRequest))
	}
	return interceptor(ctx, in, info, handler)
}
